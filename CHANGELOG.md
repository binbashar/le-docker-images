...
- Create a custom image for Kaniko ([#93](https://github.com/binbashar/public-docker-images/issues/93))
- Update README.md
...
- upgrading to golang:1.17.9-stretch because of https://github.com/binbashar/le-docker-images/pull/87
- Makefile pointing to latest makesfiles lib to get docker multi-arch builds
- levearge terraform awscli image  1.1.9 and 1.2.1 released and published (new release strategy versioning still pending)
- terratest image released for terraform 1.1.3 and 1.1.9 (current tag)
...
- Fix | Fix Dockerfile urls and sourround them in quotes ([#81](https://github.com/binbashar/public-docker-images/issues/81))
...
- updating terraform to its latest version


<a name="v0.1.12"></a>
## [v0.1.12] - 2021-12-23

- Add `hcledit` to image
...
- Merge branch 'enhancement/pin_dev_requirements_version' of github.com:binbashar/le-docker-images into enhancement/pin_dev_requirements_version
- Pin dev-requirements version
- Pin dev-requirements version
- in dev-requirements.txt file version
- Merge branch 'master' into enhancement/pin_dev_requirements_version
- Pin dev-requirements.txt file version


<a name="v0.1.10"></a>
## [v0.1.10] - 2021-11-23

- Updating terratest image to use terraform 1.0.9
...
- Create docker image for Terraform 1.0.9 ([#50](https://github.com/binbashar/public-docker-images/issues/50))
...
[v0.1.10]: https://github.com/binbashar/public-docker-images/compare/v0.1.9...v0.1.10
